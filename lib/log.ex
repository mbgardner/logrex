...
#
#   def init(:console) do
#     config = Application.get_env(:logrex)
...
#     config = configure_merge(Application.get_env(:logrex), opts)
#     {:ok, init(config, %__MODULE__{})}
#   end
#
...
#     padding = Keyword.get(config, :padding, 44)
#
#     %{state | format: format, metadata: metadata, padding: padding,
